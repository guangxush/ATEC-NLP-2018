...
from dataset import sentence_to_index_array, create_dictionaries, load_all_sentence
...
def train_model(data_1, data_2, labels, test_1, test_2, test_label, embedding_weights, n_symbols):
    ...
    bst_model_path = STAMP + '_myword256_20_bal' + '.h5'
...
if __name__ == '__main__':
    ...
    train_dataset1, train_dataset2, labels = load_all_sentence('./util/train_data_new_bal_ag.txt', '2')
