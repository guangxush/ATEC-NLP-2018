...
## 测试结果
### 使用XXX方法
|模型/方法	|Train f1|Dev f1|Pubulic Test A f1|Pubulic Test A f1|备注说明|
|---------|:---:|:----:|:--:|:--:|------|
...
|features+MLP |0.4836|0.4189|0.3939||0.3939|特征+MLP二分类|
|embedding+lstm|0.4836|0.4189|0.3939|0.00|0.3939|词向量+lstm+mlp二分类|
|embedding+cnn|0.4836|0.4189|0.3939|0.00|0.3939|词向量+cnn+mlp二分类|
